                ...
                <form className="flex flex-col gap-6 w-full" onSubmit={handleSubmit}>
                    ...
                    <div>
                        <button
                            ...
                            className={`py-3 w-full max-w-[228px] px-8 text-white bg-corporate font-semibold hover:bg-hover_corporate mb-[24px] mdx:mb-[30px] 2xl:mt-[34px] 3xl:mt-[34px] ${loading ? "opacity-50 cursor-not-allowed" : ""
                                }`}
                        >

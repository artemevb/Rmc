...
import build2 from "@/public/images/new_buildings/h-photo.png";
import build1 from "@/public/images/new_buildings/table.png";
import { useTranslations } from 'next-intl';
import React from 'react';

export default function Invest() {
    const t = useTranslations('NewBuildings.InTashkent');

        ...
        <div className="w-full flex flex-col gap-[16px] mdl:flex-row">
          <div
            className='
              ...
              pt-[24px] pl-[24px]
              bg-[#EDF3F5]
              min-h-[350px]         /* вместо h-[350px] */
              3xl:min-h-[540px]
              relative
              overflow-hidden       /* можно убрать через md:overflow-hidden, если нужно */
            '
          >
            ...
            <div
              className='
                ...
                3xl:bottom-[-30px]  /* На сверхбольших экранах уводим ещё дальше */
                right-0
                md:right-[-20px]
                h-[45%]
              '
        ...
        <div className="w-full flex flex-col 3xl:grid 3xl:grid-cols-1 gap-[16px]">
          ...
          >
            ...
            <div
              className='
                absolute
                bottom-0           /* вместо bottom-[0px] */
                md:bottom-[0px]
                3xl:bottom-[0px]
                right-[-40px]      /* можно тоже скорректировать через брейкпоинты */
                3xl:right-[-10px]
                h-[70%]
              '
            >

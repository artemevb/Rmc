...
export default function Invest() {
    ...
    const images = [
        { src: build1, alt: "Жилые комплексы", subtitle: t('subtitle-1'), href: 'new-buildings' },
        { src: build3, alt: "Коммерческая недвижимость", subtitle: t('subtitle-2'), href: 'new-buildings' },
        { src: build5, alt: "Офисы и коворкинги", subtitle: t('subtitle-3'), href: 'new-buildings' },
        { src: build7, alt: "Отели и гостиничные апартаменты", subtitle: t('subtitle-4'), href: 'new-buildings' },
        { src: build9, alt: "Виллы и таунхаусы", subtitle: t('subtitle-5'), href: 'new-buildings' },
    ];
        ...
        <div className='w-full h-auto flex flex-col mx-auto max-xl:px-[10px] max-w-[1440px]'>
            ...
            <div className='mt-6 hidden mdx:block'>
                ...
                <div className='xl:hidden mb-3 relative'>
                    <Link href={'new-buildings'} passHref>
                        <Image
                            src={build1}
                            alt="Жилые комплексы"
                            width={1000}
